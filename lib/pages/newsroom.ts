...
export const pressPage: PressPageContent = {
  ...
  coverage: {
    ...
    standfirst:
      "Selected coverage of the group's projects, joint ventures and community work.",
    ...
    entries: [
      ...
      },
      {
        id: "coverage-4",
        meta: "February 2024",
        title: "A school built by its developer",
  ...
  enquiries: {
    ...
    entries: [
      ...
      },
      {
        id: "csr",
        meta: "CSR",
        title: "Community and sustainability work",
        note: "The schools, and the practices the group builds to on site.",
        href: "/sustainability",
        action: "Read",
      },
    ],
  ...
  awards: {
    ...
    entries: [
      ...
      },
      {
        id: "award-3",
        meta: "2023",
        title: "Community Initiative of the Year",
